...
use crate::{BLSError, BLSSignature, HashToCurve, G2_MINUS_ONE};
...
impl TryFrom<&crate::PrivKey> for G2CompressedPoint {
    ...
    fn try_from(value: &crate::PrivKey) -> Result<G2CompressedPoint, Self::Error> {
        let mut pk = value.0;
...
impl TryFrom<&crate::PrivKey> for G2Point {
    ...
    fn try_from(value: &crate::PrivKey) -> Result<G2Point, Self::Error> {
        Ok(G2Point(
